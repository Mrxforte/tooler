...
class _AdminSettingsScreenState extends State<AdminSettingsScreen> {
  ...
  Future<void> _loadCurrentSecret() async {
    final adminSettings = Provider.of<AdminSettingsProvider>(
      context,
      listen: false,
    );
  ...
  Future<void> _handleSaveSecret() async {
    ...
    final success = await adminSettings.updateSecretWord(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async => _loadCurrentSecret(),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: adminSettings.isLoading
                        ? null
                        : _handleSaveSecret,
